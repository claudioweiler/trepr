...
2. Go to your repository at [claudioweiler/trepr](https://github.com/claudioweiler/trepr).
...
- [Backend Tests Workflow](https://github.com/claudioweiler/trepr/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/claudioweiler/trepr/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/claudioweiler/trepr-backend`) and Frontend (`ghcr.io/claudioweiler/trepr-frontend`) will be available.
